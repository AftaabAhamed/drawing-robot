...
class Publisher(Node):
    ...
    def forward(self):
        ...
        # bot1_ik = self.inverse_kinematics(0,1,0)
        # bot2_ik = self.inverse_kinematics(0,1,0)
        # bot3_ik = self.inverse_kinematics(0,1,0)

        msg1.z ,msg1.y ,msg1.x = self.pwm1.get_pwm(self.inverse_kinematics(0,1,0))
        msg2.z ,msg2.y ,msg2.x = self.pwm2.get_pwm(self.inverse_kinematics(0,1,0))
        msg3.z ,msg3.y ,msg3.x = self.pwm3.get_pwm(self.inverse_kinematics(0,1,0))

        # msg1.z ,msg1.y ,msg1.x = self.inverse_kinematics(0,1,0)
        # msg2.z ,msg2.y ,msg2.x = self.inverse_kinematics(0,1,0)
        # msg3.z ,msg3.y ,msg3.x = self.inverse_kinematics(0,1,0)
    ...
    def left(self):
        ...
        msg1.z ,msg1.y ,msg1.x = self.pwm1.get_pwm(self.inverse_kinematics(1,0,0))
        msg2.z ,msg2.y ,msg2.x = self.pwm2.get_pwm(self.inverse_kinematics(1,0,0))
        msg3.z ,msg3.y ,msg3.x = self.pwm3.get_pwm(self.inverse_kinematics(1,0,0))
    ...
    def motor(self , x, y, z):
        ...
        msg1.x ,msg1.y ,msg1.z =  float(x) ,float(y) ,float(z)
        msg2.x ,msg2.y ,msg2.z =  float(x) ,float(y) ,float(z)
        msg3.x ,msg3.y ,msg3.z =  float(x) ,float(y) ,float(z)  

        # self.publisher1_.pfublish(msg1)
        self.publisher2_.publish(msg2)
        # self.publisher3_.publish(msg3)
