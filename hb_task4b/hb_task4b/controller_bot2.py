...
def main(args=None):
    ...
    bot_path_list = ['/home/e-yanthra/eyrc_hb/hb_task4_ws/src/hb_task4b/hb_task4b/motor_cal/21.txt',
    ...
    while rclpy.ok():            
            ...
            if ((abs(error_x)<10) and (abs(error_y)<10) and (abs(error_theta)<0.2) ):  #and (abs(error_theta)<0.2)  
